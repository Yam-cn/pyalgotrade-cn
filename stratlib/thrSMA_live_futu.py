...
def runStratOnFutu(strat, paras, security_id, market, frequency):    
    from pyalgotrade.cn.futu.barfeed import FutuLiveFeed
    liveFeed = FutuLiveFeed([security_id], frequency, 1024, 20)
...
if __name__ == "__main__": 
    ...
    runStratOnFutu(strat, paras, "HK.00700", "HK", frequency)
